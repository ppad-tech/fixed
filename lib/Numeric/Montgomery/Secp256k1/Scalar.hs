...
redc# l u =
  let !m = (# 0xBFD25E8CD0364141##, 0xBAAEDCE6AF48A03B##    -- group order
           ,  0xFFFFFFFFFFFFFFFE##, 0xFFFFFFFFFFFFFFFF## #)
...
to#
  ...
  -> (# Word#, Word#, Word#, Word# #)
to# x =
  let !r2 = (# 0x896CF21467D7D140##, 0x741496C20E7CF878##    -- r^2 mod m
...
inv#
  ...
  -> (# Word#, Word#, Word#, Word# #)
inv# a =
  let !t0 = (# 0x402DA1732FC9BEBF##, 0x4551231950B75FC4##
            ,  0x0000000000000001##, 0x0000000000000000## #)
      !t1 = sqr# t0
      !t2 = mul# a t1
      !t3 = sqr# t2
